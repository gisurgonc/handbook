...
Assisting port in LLQ: - 5mm or 12m port inferior to the midway point between Port #3 and Port #4. (Can be used later for robotic stapler port #3A)
...
Can be done with bipolar + monopolar scissors or Extend vessel sealer Enter lesser sac and check for peritoneal disease posterior to stomach on an anterior surface of pancreas
